...
/*getElementById는 Document 객체의 메서드로, 
HTML 문서 내에서 주어진 ID 값을 가진 요소를 선택하는 역할*/
let btn1 = document.getElementById('btn1');

    // btn1요소에 클릭 이벤트 발생하면 함수 실행
    btn1.addEventListener('click', function(){
        /* area.innerHTML= '실행'
        innerHTML은 DOM 요소의 속성(property)으로, 
        해당 요소의 내부 HTML 콘텐츠를 나타냅니다. */
